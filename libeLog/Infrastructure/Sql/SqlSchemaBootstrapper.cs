    ...
    public static class SqlSchemaBootstrapper
    {
        ...
        public static List<TableDefinition> GetAllTableDefinitions() => new()
        {
            ...
            new TableBuilder("cnc_machines")
                ...
                .AddStringColumn("CurrentCSSignal", 8, true)
                .AddStringColumn("CurrentPlaneSignal", 8, true)
                ...
                .AddStringColumn("MSTLKSignal", 8, true)
                .AddStringColumn("MLKSignal", 8, true)
                ...
                .AddStringColumn("AlarmMessageSignal", 8, true)
                .AddStringColumn("LoadXSignal", 8, true)
                .AddStringColumn("LoadYSignal", 8, true)
                .AddStringColumn("LoadZSignal", 8, true)
                .AddStringColumn("LoadCSignal", 8, true)
                .AddStringColumn("LoadBSignal", 8, true)
                .AddStringColumn("LoadWSignal", 8, true)
                .AddStringColumn("LoadSpindle1Signal", 8, true)
                .AddStringColumn("LoadSpindle2Signal", 8, true)
                .Build(),
