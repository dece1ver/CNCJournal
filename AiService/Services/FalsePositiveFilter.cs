...
public static class FalsePositiveFilter
{
    ...
    ///     если сигнал явно называет деталь, сверяем СТАТУС ИМЕННО ЭТОЙ детали
    ///     (2026-07-22: раньше проверка была день-уровневой — б/н-деталь дня
    ///     гасила сигнал про совсем другую деталь с реальной наладкой);
